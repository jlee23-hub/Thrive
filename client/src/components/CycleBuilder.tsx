  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: token("space.300") }}>
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: "flex", border: `1px solid ${token("color.border")}`, borderRadius: token("border.radius.400"), overflow: "hidden" }}>
          <div
            style={{
              width: 280,
              borderRight: `1px solid ${token("color.border")}`,
...
function UsersTabContent() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: token("space.200") }}>
      ...
      {usersSubTab === "users" && (
        <>
          <div style={{ border: `1px solid ${token("color.border")}`, borderRadius: token("border.radius.400"), overflow: "hidden" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
