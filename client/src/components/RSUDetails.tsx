...
function EquitySummary({ grants: allGrants, grantYearFilter, setGrantYearFilter, vestingScheduleData: vsd, modeledPrice }: { grants: Grant[]; grantYearFilter: string; setGrantYearFilter: (v: string) => void; vestingScheduleData: typeof vestingScheduleData; modeledPrice: number }) {
  return (
    <div style={cardStyle}>
...
export default function RSUDetails() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: token("space.400") }}>
      ...
      <EquitySummary grants={grants} grantYearFilter={grantYearFilter} setGrantYearFilter={setGrantYearFilter} vestingScheduleData={vestingScheduleData} modeledPrice={modeledPrice} />
