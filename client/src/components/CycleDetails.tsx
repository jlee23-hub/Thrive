...
export default function CycleDetails({ cycle, onBack }: CycleDetailsProps) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: token("space.300") }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: "#cycle-details-tabs [role='tabpanel'] { max-width: none !important; width: 100% !important; } #cycle-details-tabs div[id$='-tab'] { max-width: none !important; width: 100% !important; } #cycle-details-tabs [role='tabpanel'] > div { max-width: none !important; width: 100% !important; }" }} />
